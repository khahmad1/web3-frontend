...
import '../style/orderAnimation.css'
...
const TruckAnimation = () => {
  ...
  return (
    <div className="  bg-gradient-to-r from-primary to-gray-100  !h-[63vh] !flex flex-col gap-10 !justify-center !items-center">
      <Link  to={"/choose-your-product"} className="text-5xl text-white font-bold underline" > Get An Order </Link>
    <div className="road">
